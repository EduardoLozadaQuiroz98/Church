...
<head>
    ...
    <title>Mision Chalco Mex &mdash; Free Website Template, Free HTML5 Template by freehtml5.co</title>
                ...
                <div class="top-menu">
                    <div class="row">
                        <div class="col-md-12 col-offset-0 text-center">
                            <div id="fh5co-logo"><a href="index.php">Mision Chalco Mex</a></div>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-md-offset-3 text-center slider-text">
                                        <div class="slider-text-inner">
                                            <h1>Contact Us</h1>
                                            <h2>Description <a href="http://freehtml5.co/" target="_blank">freehtml5.co</a></h2>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-3 col-md-push-8 animate-box">
                        ...
                        <ul class="contact-info">
                            <li><i class="icon-location4"></i>Cuernavaca Morelos </li>
                    ...
                    <div class="col-md-7 col-md-pull-2 animate-box">
                        <form action="process_form.php" method="POST">
                            <!-- Cambia "process_form.php" a la URL correcta -->
                            <div class="row">
                                <div class="col-md-6">
        ...
        <div class="container-wrap">
            <footer id="fh5co-footer" role="contentinfo">
                <div class="col-md-4 text-center">
                    <h3>Cuernavaca Morelos </h3>
                </div>
                <div class="col-md-4 text-center">
                    <h2><a href="#">Mision Chalco Mex</a></h2>
                </div>
                <div class="col-md-4 text-center">
                    <p>
                ...
                <div class="row copyright">
                    <div class="col-md-12 text-center">
                        <p>
                            <small class="block">&copy; 2023 Todos los derechos reservados para DevEd.</small>
                        </p>
                    </div>
                </div>
            </footer>
